...
if __name__ == '__main__':
    ...
    dataset_train = datasets.ImageFolder(os.path.join(DATA_ROOT, 'IMG'), train_transform)
    ...
    if BACKBONE_RESUME_ROOT or HEAD_RESUME_ROOT:
        print("=" * 60)
        ...
        if os.path.isfile(HEAD_RESUME_ROOT):
            ...
            print("No Head Checkpoint Found at '{}'.".format(HEAD_RESUME_ROOT))
    else:
